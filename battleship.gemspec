...
Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Battleship'
  spec.description   = 'A guessing game for two players'
  spec.homepage      = 'https://github.com/stephancom/battleship'
  spec.license       = 'MIT'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/stephancom/battleship'
    spec.metadata['changelog_uri'] = 'https://github.com/stephancom/battleship/blob/master/CHANGELOG.md'
  else
